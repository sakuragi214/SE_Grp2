...
Public Class MainMenu
    ...
    Private Sub SaveINData()
        ...
        SQL.ExecQuery("insert into TransactionTbl(PlateNumber,VehicleType,DateIn,TimeIn) values('" & txtPlateIN.Text & "','" & txtTypeIN.SelectedItem & "','" & txtDate.Text & "','" & txtTime.Text & "') ")
